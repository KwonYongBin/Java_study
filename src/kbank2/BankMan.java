...
public class BankMan {
	...
	public static final int ACCONT_PASSWORD = 3;
	...
	public boolean valideteCheck(AccountPaperVo updateAccountPaper) {
	...
	public void processWithdrawal() {
		System.out.println(this.name + "출금요청 처리 진행중 입니다. 잠시만 기다려주세요");
		...
		if(accountIdx != -1) {
			...
			System.out.println(this.name + "계좌 정보가 일치하지 않습니다. 확인 후 다시 진행 해주세요");				
		}
	}
	...
	public void steAccountPaper(AccountPaperVo accountPaper) {
		this.accountPaper = accountPaper;
		System.out.println(this.name + " 고겍에게 출금용지 받음!");
	}
