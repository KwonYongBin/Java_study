...
public class ArrayTest04 {
	...
	public static void main(String[] args) {
		...
		Scanner[] scanList = new Scanner[3]; // Scanner scan = new Scanner(System.in)*3 과 같은 의미.
		...
		// 0번째 주소에 2의 주소가 적용돼서 기존에 있던 0의 주소는 가베이지 컬렉터의 대상이 된다.
		//(가비지 컬렉션 이란? → 아무도 안 쓰는 객체를 자동으로 청소한다)
		System.out.println(scanList[0].hashCode());
		System.out.println(scanList[1].hashCode());
		System.out.println(scanList[2].hashCode());
		...
		nList [0] = nList[2];// call by value → 값만 복사해서 쓰고, 원본은 안 바뀐다
