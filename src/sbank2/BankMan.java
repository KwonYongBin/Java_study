...
public class BankMan {
	 ...
	 public void showAccountList() {
		 for(int i = 0; i < accountList.length; i++) {
			 ...
			 System.out.println(account.getBalsnce() + ".\t");
		 }
	 }
	  ...
	  */
	 public AccountVo[] createAccountList(){ //리턴타입은 항상 동일해야 하기 때문에 createAccountList()를 담고있는 accountList배열의 타입을 리턴
