...
public class ObjectTypeCastingTest {
	...
	public static void main(String[] args) {
		...
		Shape s = new Circle("초록색", 2);// 자동(묵시) 형변환
		Circle cs = (Circle)s; //명시적(강제) 형변환 O
//		Rectangle r = (Rectangle)s; 명시적(강제) 형변환 X : 생성된 같은 모습의 자식만 가능!!
		
		Shape s2 = new Shape("빨강");
	  //Circle cs2 = (Circle)s2; //명시적(강제) 형변환 X
		...
		//사각형, 삼각형
		ShapeInterface si2 = new Rectangle("브라운", 3, 2);
